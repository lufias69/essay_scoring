...
__author__ = 'Jean-Bernard Ratte - jean.bernard.ratte@unary.ca'
 ...
 Find the Jaro Winkler Distance which indicates the similarity score between two Strings.
    ...
    httpen.wikipedia.orgwikiJaro%E2%80%93Winkler_distance
    This Python implementation is based on the Apache StringUtils implementation from
    httpcommons.apache.orgpropercommons-langapidocssrc-htmlorgapachecommonslang3StringUtils.html#line.7141
...
def _get_matching_characters(first, second)
    ...
    for i, l in enumerate(first)
        ...
        if l in second[leftright]
            common.append(l)
            second = second[0second.index(l)] + '' + second[second.index(l) + 1]
